...
More testing resulted in Issue #216, and changed the defaults to:
...
The problem with scaling, without using the SetProcessDpiAwareness(Context) API, is that items could be blurry.
