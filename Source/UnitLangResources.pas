...
resourcestring
  ...
  StrCheckTheGeoCodeRe      = 'Check the GeoCode requirements. (Apikey required. ' +
                              'Max 1 call per second for a free account)';
  ...
  StrScreenResolution       = 'Screen resolution: ';
  StrScaled                 = 'Scaled: ';
  ...
  ImportMetaSel2            = 'currently *selected* ';
